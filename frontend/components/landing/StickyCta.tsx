...
export function StickyCta() {
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-x-0 bottom-0 -z-10 h-20 bg-[radial-gradient(ellipse_50%_100%_at_50%_100%,rgba(205,152,66,0.4),transparent_70%)] blur-xl" />
      <div className="pointer-events-auto relative flex w-full max-w-3xl items-center gap-3 rounded-2xl border border-white/10 bg-[#14100A]/40 px-4 py-2.5 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.8)] backdrop-blur-md sm:gap-4 sm:rounded-full sm:px-5 sm:py-3">
        ...
        <div className="ml-auto flex shrink-0 items-center gap-2">
          ...
          <Link
            ...
            className="group relative inline-flex items-center gap-1.5 overflow-hidden rounded-full bg-gradient-to-r from-[#E4BC74] via-[#CD9842] to-[#AC6824] px-3.5 py-2 text-xs font-semibold text-white shadow-[0_0_24px_-4px_rgba(205,152,66,0.7)] sm:px-4 sm:text-sm"
          >
