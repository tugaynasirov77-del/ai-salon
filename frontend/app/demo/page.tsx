...
export default function DemoPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#0F1216] text-slate-100">
      ...
      {/* Header */}
      <header className="sticky top-0 z-30 border-b border-white/[0.06] bg-[#0F1216]/70 backdrop-blur-xl">
      ...
      <section className="px-4 pb-16">
        <div className="mx-auto grid max-w-7xl gap-5 lg:grid-cols-2">
          ...
          <div className="overflow-hidden rounded-2xl border border-white/10 bg-[#1F232A]/70 shadow-[0_30px_80px_-20px_rgba(59,130,246,0.4)] backdrop-blur-xl">
            ...
            <div ref={scrollRef} className="flex h-[480px] flex-col gap-3 overflow-y-auto bg-[#0F1216]/40 px-4 py-5 sm:px-6">
              {messages.map(m => (
