        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div className="min-w-[240px]">
            ...
            <select
              ...
              className="h-10 w-full rounded-lg border border-slate-300 bg-white px-3 text-sm text-[#181B22] focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500/20 dark:border-slate-700 dark:bg-[#181B22] dark:text-slate-100"
            >
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    !d?.open && 'bg-slate-50/50 dark:bg-[#181B22]/30',
                  )}
                >
                  <label className="flex w-44 cursor-pointer items-center gap-3">
                    ...
                    <span
                      className={cn(
                        'text-sm font-medium',
                        d?.open ? 'text-[#181B22] dark:text-slate-100' : 'text-slate-400',
                    ...
                    <>
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className={cn(
                            'h-9 rounded-md border bg-white px-2 text-sm dark:bg-[#181B22]',
