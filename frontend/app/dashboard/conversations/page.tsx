    ...
    <div>
      ...
      <Card className="overflow-hidden">
        <div className="grid h-[calc(100vh-220px)] min-h-[500px] grid-cols-1 md:grid-cols-[320px_1fr]">
                            ...
                            <div className="mt-0.5 flex items-center gap-2">
                              <div
                                className={cn(
                                  ...
                                  (it.unreadCount || 0) > 0
                                    ? 'font-semibold text-[#1E2329] dark:text-slate-100'
          ...
          {/* ===== Правая панель — тред ===== */}
          <section className="flex min-h-0 flex-col bg-slate-50 dark:bg-[#1E2329]/40">
            {!selectedId ? (
...
function ConversationDetail({
  ...
  return (
    <>
      {/* Шапка */}
      <header className="border-b border-slate-200 bg-white px-5 py-3 dark:border-slate-800 dark:bg-[#1E2329]">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            <div className="truncate font-semibold text-[#1E2329] dark:text-slate-100">
      ...
      {appointments.length > 0 && (
        <div className="border-b border-slate-200 bg-white px-5 py-2 dark:border-slate-800 dark:bg-[#1E2329]">
                    ...
                    className={cn(
                      ...
                      out && byOwner
                        ...
                        : out
                          ...
                          : 'rounded-bl-md bg-white text-[#1E2329] shadow-sm dark:bg-slate-800 dark:text-slate-100',
                    )}
                  >
                    {out && (
      ...
      <footer className="border-t border-slate-200 bg-white px-4 py-3 dark:border-slate-800 dark:bg-[#1E2329]">
        {sendError && (
        ...
        <div className="flex items-end gap-2">
          <textarea
            ...
            rows={1}
            disabled={sending}
            className="flex-1 resize-none rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-[#1E2329] placeholder:text-slate-400 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500 disabled:opacity-60 dark:border-slate-700 dark:bg-[#14181F] dark:text-slate-100"
          />
          <button
            onClick={send}
