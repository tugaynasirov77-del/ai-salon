...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  if (!loaded || !user) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-50 dark:bg-[#0E121A]">
  ...
  return (
    <div className="relative min-h-screen bg-slate-50 text-[#181B22] dark:bg-[#0E121A] dark:text-slate-100">
      ...
      <div className="flex items-center justify-between border-b border-slate-200 bg-white px-4 py-3 md:hidden dark:border-white/[0.06] dark:bg-[#0E121A]/80 dark:backdrop-blur-xl">
      ...
      <aside
        className={cn(
          ...
          'dark:border-white/[0.06] dark:bg-[#0E121A]/80 dark:backdrop-blur-xl',
          'md:translate-x-0',
