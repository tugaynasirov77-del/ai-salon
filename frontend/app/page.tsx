...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#181C24] text-slate-100">
      ...
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-[#181C24]">
        {/* Aurora-mesh blobs */}
      ...
      <section id="demo" className="relative py-24">
        <div className="mx-auto max-w-5xl px-4">
          ...
          >
            <div className="relative rounded-[22px] bg-[#181C24]/70 p-6 sm:p-10">
...
function Feature({ icon, title, text }: { icon: React.ReactNode; title: string; text: string }) {
  return (
    <div className="group relative bg-[#181C24]/40 p-7 transition-colors duration-300 hover:bg-white/[0.04]">
      {/* hover glow */}
  ...
  return (
    <header className="fixed inset-x-0 top-3 z-40 px-3 sm:top-5 sm:px-4">
      <div className="relative mx-auto max-w-4xl">
        ...
        <div className="flex items-center justify-between gap-3 rounded-2xl border border-white/10 bg-[#181C24]/40 px-3 py-2.5 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.8)] backdrop-blur-md sm:rounded-full sm:px-5">
    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 lg:hidden">
          {/* Backdrop */}
          <div
            className="absolute inset-0 bg-[#181C24]/80 backdrop-blur-sm"
            onClick={() => setOpen(false)}
          />
          {/* Panel */}
          <div className="absolute inset-x-0 top-0 border-b border-white/10 bg-[#181C24]/95 px-4 pb-6 pt-4 shadow-2xl backdrop-blur-xl">
...
function DashboardMockup() {
  return (
    <div className="overflow-hidden rounded-2xl border border-white/10 bg-[#232831]/95 shadow-[0_30px_80px_-20px_rgba(59,130,246,0.4)] backdrop-blur-sm">
      {/* Window chrome */}
