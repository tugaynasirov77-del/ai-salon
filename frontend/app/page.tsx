  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950 text-slate-100">
      ...
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-[#05060f]">
        {/* Aurora-mesh blobs */}
        <div className="liva-aurora absolute -top-40 -left-40 h-[560px] w-[560px] rounded-full bg-[#A9742E]/30 blur-[150px]" />
        <div className="liva-aurora-2 absolute top-[12%] -right-40 h-[520px] w-[520px] rounded-full bg-[#A9742E]/25 blur-[150px]" />
        <div className="liva-aurora absolute top-[55%] left-1/4 h-[460px] w-[460px] rounded-full bg-[#CFA049]/20 blur-[150px]" />
        <div className="liva-aurora-2 absolute bottom-0 right-1/4 h-[420px] w-[420px] rounded-full bg-[#A9742E]/20 blur-[150px]" />
        {/* Top glow */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_50%_0%,rgba(230,196,128,0.10),transparent_60%)]" />
        {/* Neural grid */}
      ...
      <section className="relative">
        <div className="mx-auto max-w-6xl px-4 pt-24 pb-28 text-center sm:pt-32 sm:pb-36">
          <div className="reveal is-visible inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-4 py-1.5 text-xs font-medium text-slate-300 shadow-[0_0_30px_-8px_rgba(230,196,128,0.5)] backdrop-blur">
            <span className="relative flex h-2 w-2">
              <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#E6C480] opacity-75" />
              <span className="relative inline-flex h-2 w-2 rounded-full bg-[#E6C480]" />
            </span>
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link
              ...
              className="group relative inline-flex w-full items-center justify-center gap-2 overflow-hidden rounded-xl bg-gradient-to-r from-[#E6C480] via-[#CFA049] to-[#A9742E] px-7 py-3.5 text-base font-semibold text-white shadow-[0_0_50px_-6px_rgba(207,160,73,0.7)] transition-all hover:scale-[1.02] hover:shadow-[0_0_60px_-4px_rgba(230,196,128,0.7)] sm:w-auto"
            >
            ...
            >
              <span className="flex h-5 w-5 items-center justify-center rounded-full bg-white/10 transition-colors group-hover:bg-[#E6C480]/20">
      ...
      <section className="reveal relative border-y border-white/[0.06] bg-white/[0.01] py-9">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 px-4 lg:flex-row lg:justify-between lg:gap-10">
          ...
          <div className="flex shrink-0 items-center gap-2.5">
            <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-[#E6C480]/20 to-[#CFA049]/20 ring-1 ring-inset ring-white/10">
              <Sparkles className="h-4 w-4 text-[#E6C480]" strokeWidth={1.5} />
            </span>
      ...
      <section id="demo" className="relative py-24">
        <div className="mx-auto max-w-5xl px-4">
          <div className="reveal text-center">
            <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#E6C480]">Демо</span>
            <h2 className="mt-3 bg-gradient-to-b from-white to-white/70 bg-clip-text text-4xl font-semibold tracking-tight text-transparent sm:text-5xl">
          ...
          <Link
            ...
            className="border-gradient reveal group relative mx-auto mt-12 block max-w-3xl overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-amber-950/40 via-amber-950/30 to-amber-900/40 p-1 transition-all duration-300 hover:scale-[1.01] hover:shadow-[0_20px_70px_-20px_rgba(230,196,128,0.5)]"
          >
            <div className="relative rounded-[22px] bg-slate-950/70 p-6 sm:p-10">
              <div className="grid items-center gap-8 sm:grid-cols-2 sm:gap-10">
                ...
                <div className="order-1 text-center sm:order-2 sm:text-left">
                  ...
                  <span className="mt-7 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-[#CFA049] via-[#CFA049] to-[#A9742E] px-6 py-3.5 text-base font-semibold text-white shadow-[0_0_40px_rgba(207,160,73,0.5)] transition-transform group-hover:scale-[1.03]">
                    Открыть полное демо
                    <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-0.5" />
                  </span>
                </div>
      ...
      <section id="features" className="relative py-24">
        <div className="mx-auto max-w-6xl px-4">
          <div className="reveal text-center">
            <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#E6C480]">Возможности</span>
            <h2 className="mt-3 bg-gradient-to-b from-white to-white/70 bg-clip-text text-4xl font-semibold tracking-tight text-transparent sm:text-5xl">
      ...
      <section id="how" className="relative py-24">
        <div className="mx-auto max-w-6xl px-4">
          <div className="reveal text-center">
            <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#E6C480]">Как это работает</span>
            <h2 className="mt-3 bg-gradient-to-b from-white to-white/70 bg-clip-text text-4xl font-semibold tracking-tight text-transparent sm:text-5xl">
      ...
      <section className="relative py-24">
        <div className="mx-auto max-w-6xl px-4">
          <div className="reveal text-center">
            <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#E6C480]">9 ниш</span>
            <h2 className="mt-3 bg-gradient-to-b from-white to-white/70 bg-clip-text text-4xl font-semibold tracking-tight text-transparent sm:text-5xl">
          ...
          <div className="mx-auto mt-12 grid max-w-4xl grid-cols-2 gap-3 sm:grid-cols-3">
            {Object.values(NICHES).map((n: any) => (
              <div
                key={n.key}
                className="group flex items-center gap-3 rounded-xl border border-white/10 bg-white/[0.025] px-4 py-3.5 text-sm text-slate-200 backdrop-blur-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-[#E6C480]/30 hover:bg-white/[0.05] hover:shadow-[0_8px_30px_-12px_rgba(230,196,128,0.5)]"
              >
      ...
      <section id="faq" className="relative py-24">
        <div className="mx-auto max-w-3xl px-4">
          <div className="reveal text-center">
            <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#E6C480]">Частые вопросы</span>
            <h2 className="mt-3 bg-gradient-to-b from-white to-white/70 bg-clip-text text-4xl font-semibold tracking-tight text-transparent sm:text-5xl">
              Отвечаем заранее
            </h2>
          </div>
          ...
          <p className="mt-10 text-center text-sm text-slate-400">
            ...
            <a href="mailto:hello@ailiva.ru" className="text-[#E6C480] hover:text-white">
              hello@ailiva.ru
            </a>
          </p>
        </div>
      ...
      <section className="relative py-20">
        <div className="mx-auto max-w-4xl px-4">
          <div className="border-gradient reveal relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-amber-950/40 via-amber-950/30 to-amber-900/40 p-10 text-center sm:p-14">
            <div className="absolute -top-32 left-1/2 -translate-x-1/2 h-[300px] w-[600px] rounded-full bg-[#A9742E]/25 blur-[100px]" />
            <div className="absolute -bottom-32 left-1/4 h-[260px] w-[460px] rounded-full bg-[#CFA049]/15 blur-[110px]" />
            <div className="relative">
              ...
              <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
                <Link
                  ...
                  className="group relative inline-flex w-full items-center justify-center gap-2 overflow-hidden rounded-xl bg-gradient-to-r from-[#CFA049] via-[#CFA049] to-[#A9742E] px-7 py-3.5 text-base font-semibold text-white shadow-[0_0_40px_rgba(207,160,73,0.5)] transition-transform hover:scale-[1.02] sm:w-auto"
                >
  ...
  return (
    <div ref={setEl} onMouseMove={onMove} className="group reveal relative mt-16">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(260px circle at var(--x) var(--y), rgba(230,196,128,0.10), transparent 65%)',
        }}
      />
...
function Feature({ icon, title, text }: { icon: React.ReactNode; title: string; text: string }) {
  return (
    <div className="group relative bg-slate-950/40 p-7 transition-colors duration-300 hover:bg-white/[0.04]">
      {/* hover glow */}
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_30%_0%,rgba(230,196,128,0.12),transparent_60%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
      <div className="relative flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-[#E6C480]/20 via-[#CFA049]/20 to-[#A9742E]/20 text-[#F0D9A8] ring-1 ring-inset ring-white/10 transition-all duration-300 group-hover:ring-[#E6C480]/40 group-hover:shadow-[0_0_24px_-4px_rgba(230,196,128,0.6)]">
        {icon}
      </div>
  ...
  return (
    <header className="fixed inset-x-0 top-3 z-40 px-3 sm:top-5 sm:px-4">
      <div className="relative mx-auto max-w-4xl">
        ...
        <div className="pointer-events-none absolute -inset-x-10 -top-6 -z-10 h-24 bg-[radial-gradient(ellipse_50%_100%_at_50%_0%,rgba(207,160,73,0.4),transparent_70%)] blur-xl" />
        <div className="flex items-center justify-between gap-3 rounded-2xl border border-white/10 bg-slate-950/40 px-3 py-2.5 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.8)] backdrop-blur-md sm:rounded-full sm:px-5">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <Link
              ...
              className="group relative hidden items-center gap-1.5 overflow-hidden rounded-full bg-gradient-to-r from-[#E6C480] via-[#CFA049] to-[#A9742E] px-4 py-2 text-sm font-semibold text-white shadow-[0_0_24px_-4px_rgba(207,160,73,0.7)] transition-transform hover:scale-[1.03] sm:inline-flex"
            >
              <span className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-white/30 to-transparent transition-transform duration-700 group-hover:translate-x-full" />
              Попробовать бесплатно
          ...
          <div className="absolute inset-x-0 top-0 border-b border-white/10 bg-slate-950/95 px-4 pb-6 pt-4 shadow-2xl backdrop-blur-xl">
            ...
            <div className="mx-auto mt-5 flex max-w-6xl flex-col gap-3 border-t border-white/[0.06] pt-5">
              <Link
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#CFA049] via-[#CFA049] to-[#A9742E] px-6 py-3 text-base font-semibold text-white shadow-[0_0_24px_rgba(207,160,73,0.45)]"
              >
                Попробовать бесплатно
                <ArrowRight className="h-4 w-4" />
              </Link>
...
const CHANNEL_TONES: Record<string, string> = {
  indigo: 'border-[#E6C480]/30 bg-[#CFA049]/10 text-[#F0D9A8]',
  emerald: 'border-emerald-400/30 bg-emerald-500/10 text-emerald-200',
  orange: 'border-orange-400/30 bg-orange-500/10 text-orange-200',
  cyan: 'border-[#E6C480]/30 bg-[#CFA049]/10 text-[#F0D9A8]',
};
...
function InteractiveMockup() {
  ...
  return (
    <div className="relative mx-auto mt-14 max-w-5xl px-4">
      ...
      <div className="absolute -inset-x-12 -inset-y-10 -z-10 rounded-[48px] bg-gradient-to-b from-[#CFA049]/15 via-[#CFA049]/15 to-transparent blur-3xl" />
          ...
          >
            ...
            <FloatCard className="absolute -right-8 top-8 hidden w-[250px] lg:block" depth={180} delay="-2s">
              <div className="flex items-start gap-2.5">
                <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#CFA049] to-[#A9742E] text-[11px] font-semibold text-white">К</span>
                <div className="min-w-0">
            ...
            <FloatCard className="absolute -bottom-8 left-10 hidden w-[240px] md:block" depth={100} delay="-4s">
              <div className="flex items-center gap-2.5">
                <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[#CFA049]/15 text-[#E6C480] ring-1 ring-inset ring-[#E6C480]/30">
...
function DashboardMockup() {
  return (
    <div className="overflow-hidden rounded-2xl border border-white/10 bg-slate-900/95 shadow-[0_30px_80px_-20px_rgba(207,160,73,0.4)] backdrop-blur-sm">
      {/* Window chrome */}
              ...
              <svg viewBox="0 0 300 100" className="mt-3 h-24 w-full">
                <defs>
                  <linearGradient id="mock-grad" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#CFA049" stopOpacity="0.5" />
...
function MockNavItem({ children, active }: { children: React.ReactNode; active?: boolean }) {
  return (
    <div
      className={
        active
          ? 'relative rounded-md bg-gradient-to-r from-[#CFA049]/20 via-[#CFA049]/15 to-[#A9742E]/10 px-2.5 py-1.5 text-[11px] font-medium text-white'
          : 'rounded-md px-2.5 py-1.5 text-[11px] font-medium text-slate-400'
      }
    >
      {active && <span className="absolute left-0 top-1/2 h-3 w-0.5 -translate-y-1/2 rounded-r-full bg-gradient-to-b from-[#E6C480] via-[#CFA049] to-[#CFA049]" />}
      {children}
    </div>
  );
}
...
function MockMetric({ label, to, format, trend, tone = 'indigo' }: { label: string; to: number; format?: (n: number) => string; trend?: string; tone?: 'emerald' | 'indigo' | 'violet' }) {
  const trendColor = tone === 'emerald' ? 'text-emerald-400' : tone === 'violet' ? 'text-[#E6C480]' : 'text-[#E6C480]';
  return (
...
function MockDialog({ name, channel, text, time }: { name: string; channel: string; text: string; time: string }) {
  return (
    <div className="flex items-start gap-2.5">
      <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#CFA049]/40 to-[#A9742E]/40 text-[10px] font-semibold text-white">
        {name.charAt(0)}
      </div>
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-0.5 flex items-center gap-1.5">
          <span className="text-[9px] uppercase tracking-wider text-[#E6C480]">{channel}</span>
  ...
  return (
    <details className="group rounded-2xl border border-white/10 bg-white/[0.025] backdrop-blur-sm transition-colors open:bg-white/[0.04]">
      <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-5 py-4 text-left">
        ...
        <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-white/15 text-slate-400 transition-transform group-open:rotate-45 group-open:border-[#CFA049] group-open:text-[#E6C480]">
