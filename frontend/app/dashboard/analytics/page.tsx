...
export default function AnalyticsPage() {
  ...
  return (
    <div>
      ...
      {/* График по дням */}
      <Card className="mb-4">
        <h3 className="mb-3 text-sm font-semibold text-[#232831] dark:text-slate-100">Записи по дням</h3>
        {loading ? (
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        {/* Топ-5 услуг */}
        <Card>
          <h3 className="mb-3 text-sm font-semibold text-[#232831] dark:text-slate-100">Топ-5 услуг</h3>
          {loading ? (
            <div className="py-12"><LoadingSpinner /></div>
        ...
        {/* Pie каналов */}
        <Card>
          <h3 className="mb-3 text-sm font-semibold text-[#232831] dark:text-slate-100">Источники клиентов</h3>
          {loading ? (
            <div className="py-12"><LoadingSpinner /></div>
          ) : totalChannels === 0 ? (
