  ...
  return (
    <div className="flex h-[calc(100vh-6rem)] flex-col">
      ...
      <Card className="flex flex-1 flex-col overflow-hidden p-0">
        ...
        <div className="border-t border-slate-200 bg-white px-4 py-3 dark:border-slate-800 dark:bg-[#1E2329]">
          <div className="mx-auto flex max-w-3xl flex-col gap-2">
            ...
            <div className="flex items-end gap-2">
              ...
              <button
                ...
                className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border border-slate-300 bg-white text-slate-600 transition-colors hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-700 dark:bg-[#14181F] dark:text-slate-300 dark:hover:bg-slate-800"
              >
              ...
              <button
                ...
                className={cn(
                  ...
                  recording
                    ...
                    : 'border-slate-300 bg-white text-slate-600 hover:bg-slate-50 dark:border-slate-700 dark:bg-[#14181F] dark:text-slate-300 dark:hover:bg-slate-800',
                )}
              >
