              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    !d?.open && 'bg-slate-50/50 dark:bg-[#12151C]/30',
                  )}
                >
                  <label className="flex w-44 cursor-pointer items-center gap-3">
                    ...
                    <span
                      className={cn(
                        'text-sm font-medium',
                        d?.open ? 'text-[#12151C] dark:text-slate-100' : 'text-slate-400',
                    ...
                    <>
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className={cn(
                            'h-9 rounded-md border bg-white px-2 text-sm dark:bg-[#12151C]',
