        ...
        {services.isLoading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="border-b border-slate-200 bg-slate-50 text-left text-xs font-medium uppercase tracking-wider text-slate-500 dark:border-slate-800 dark:bg-[#181B22]/50">
                <tr>
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                {list.map((s) => {
                  ...
                  return (
                    <tr key={s.id} className={cn('hover:bg-slate-50 dark:hover:bg-[#181B22]/40', !s.isActive && 'opacity-60')}>
                      <td className="px-4 py-3 font-medium text-[#181B22] dark:text-slate-100">{s.name}</td>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        active
                          ...
                          : 'border-slate-200 bg-white text-slate-600 hover:bg-slate-50 dark:border-slate-700 dark:bg-[#181B22] dark:text-slate-300',
                      )}
                    >
                      {m.name}
                    </button>
