  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950 text-slate-100">
      ...
      <header className="border-b border-white/[0.06] bg-slate-950/70 backdrop-blur-xl">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-4">
          ...
          <nav className="flex items-center gap-3 text-sm">
            ...
            <Link
              href="/register"
              className="group relative inline-flex items-center gap-1.5 overflow-hidden rounded-lg bg-gradient-to-r from-indigo-500 via-violet-500 to-fuchsia-500 px-3 py-1.5 text-sm font-semibold text-white shadow-[0_0_24px_rgba(139,92,246,0.35)]"
            >
      ...
      <main className="mx-auto flex max-w-md flex-col px-4 py-12">
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 backdrop-blur-md shadow-[0_0_60px_rgba(139,92,246,0.08)] sm:p-8">
          {children}
        </div>
      </main>
    </div>
